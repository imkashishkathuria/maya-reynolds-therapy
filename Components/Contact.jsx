        ...
        <div className='' id='contact'>
            ...
            <div className='p-15 hidden lg:flex flex-col gap-5 bg-[#03252d]'>
                <div className='flex flex-col lg:flex-row justify-between'>
                    <h1 className='text-[25px] '>Contact Dr. Maya Reynolds, PsyD</h1>
                ...
                <div className='flex justify-between'>
                    <p className='text-[20px] w-[200px]'>123th Street 45 W Santa Monica, CA 90401</p>
                ...
                <div className='flex justify-between'>
                    <p className='text-[20px] w-[200px] cursor-pointer underline'>reynoldsmaya@gmail.com (828) 725-1871</p>
            ...
            <div className="lg:hidden w-full min-h-screen bg-[#03252d] flex flex-col items-center justify-start py-12 px-6 text-center">
                ...
                <h1 className="text-2xl font-semibold mb-6">
                    Contact Dr. Maya Reynolds, PsyD
                </h1>

                {/* Address */}
                <p className="text-base leading-relaxed">
                    123th Street 45<br />
                    W Santa Monica, CA 90401
                </p>
