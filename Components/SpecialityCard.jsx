...
const SpecialityCard = ({ heading, subheading, image }) => {
    return (
        <div className='p-8 lg:w-1/3 flex flex-col gap-4 justify-between bg-[#e5e0da] border'>
            ...
            <div className='flex justify-center'>
                <Image src={image}
                    ...
                    height={10}
                    priority
                    className='w-40 lg:w-70 h-40 lg:h-70 object-cover rounded-full object-center' />
            </div>
