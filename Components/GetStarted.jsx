...
const GetStarted = () => {
    return (
        <div className='bg-[#7e7b46] py-7 lg:py-20 flex justify-center items-center'>
            <div className='flex flex-col justify-center items-center px-5 lg:px-0 gap-8 lg:pl-10  lg:w-1/2'>
                <p className='text-[30px] lg:text-[50px] font-[550] leading-13 text-white'> Get started today. </p>
